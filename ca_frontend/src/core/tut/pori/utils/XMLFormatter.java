...
public class XMLFormatter {
	 ...
	 * @param writer use the writer for marshalling the object, the writer is <i>not</i> closed, but could be flushed
	 * @throws IllegalArgumentException on invalid object
	 */
	public void toWriter(Response r, Writer writer) throws IllegalArgumentException{
		if(r == null){
